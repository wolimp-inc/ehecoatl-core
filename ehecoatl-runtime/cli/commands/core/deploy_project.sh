...
case "${1:-}" in
  -h|--help)
    cat <<'EOF'
Usage: ehecoatl core deploy project @<domain> -p <project_kit>

Deploys a project from a project kit. Kits may be folders or .zip files.
...
exec "$SCRIPT_DIR/../shared/deploy.sh" project "$@"
